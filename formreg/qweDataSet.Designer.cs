...
namespace formreg {
    ...
    public partial class qweDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string id, string Name, string Login, string Password) {
...
namespace formreg.qweDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([id] = @Original_id) AND ((@IsNull_Name = 1 AND" +
                ...
                "n] IS NULL) OR ([Login] = @Original_Login)) AND ([Password] = @Original_Password" +
                "))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([id], [Name], [Login], [Password]) VALUES (@id, @Name," +
                " @Login, @Password);\r\nSELECT id, Name, Login, Password FROM Users WHERE (id = @i" +
                "d)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [id] = @id, [Name] = @Name, [Login] = @Login, [Password] = @Password WHERE (([id] = @Original_id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Login = 1 AND [Login] IS NULL) OR ([Login] = @Original_Login)) AND ([Password] = @Original_Password));
SELECT id, Name, Login, Password FROM Users WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::formreg.Properties.Settings.Default.qweConnectionString;
        }
        ...
        public virtual int Fill(qweDataSet.UsersDataTable dataTable) {
        ...
        public virtual qweDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            qweDataSet.UsersDataTable dataTable = new qweDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(qweDataSet.UsersDataTable dataTable) {
        ...
        public virtual int Delete(string Original_id, string Original_Name, string Original_Login, string Original_Password) {
            if ((Original_id == null)) {
        ...
        public virtual int Insert(string id, string Name, string Login, string Password) {
            if ((id == null)) {
        ...
        public virtual int Update(string id, string Name, string Login, string Password, string Original_id, string Original_Name, string Original_Login, string Original_Password) {
            if ((id == null)) {
                throw new global::System.ArgumentNullException("id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Login, string Password, string Original_id, string Original_Name, string Original_Login, string Original_Password) {
